...
const WebLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Simple Header for Web Landing Page */}
      <header className="w-full fixed top-0 left-0 z-50 bg-white shadow-sm py-3">
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <div className="flex items-center">
            <a
              href="#application"
              className="bg-gowith-orange hover:bg-gowith-orange-hover text-white font-semibold py-2 px-4 rounded-lg transition-colors text-sm"
            >
        ...
        <div className="relative container mx-auto px-6 py-20 lg:py-28">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 my-16">
              ...
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-pink-500 via-red-500 to-orange-500 text-white px-4 py-2 rounded-full text-xs font-bold mb-6 animate-bounce shadow-2xl">
              ...
              <h1 className="text-3xl md:text-4xl mb-4 leading-tight font-extrabold lg:text-4xl">
                Transform Your Business with a 
                <br />
                <span className="bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent animate-pulse">$6,800 Website</span>
                <br />
                <span className="text-2xl md:text-3xl bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent my-0 py-0 mx-0 lg:text-3xl">100% FREE</span>
              </h1>
              
              <p className="text-base md:text-lg mb-4 text-cyan-200 max-w-5xl mx-auto leading-relaxed font-semibold">
                🚀 Professional websites that convert visitors into customers
                <br />
                <span className="text-sm text-purple-200 font-extrabold">Built with cutting-edge tech for ambitious businesses ready to own the digital space</span>
              </p>
              
              <p className="text-base mb-4 max-w-4xl mx-auto text-blue-200 font-medium">
                Join thriving businesses. Complete website delivered in just 14 days.
              </p>

              {/* Community Message */}
              <div className="bg-gradient-to-r from-emerald-500/30 to-teal-500/30 backdrop-blur-lg border border-emerald-400/50 rounded-3xl p-4 mb-6 max-w-5xl mx-auto shadow-2xl">
                <h2 className="text-xl md:text-2xl font-bold text-emerald-300 mb-3">Communities to Thrive</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 max-w-4xl mx-auto">
                <div className="text-center p-3 bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg rounded-3xl border border-green-400/30 hover:scale-105 transition-transform duration-300">
                  <div className="text-2xl md:text-3xl font-black text-green-400 mb-1">$6,800</div>
                  <div className="text-green-200 font-semibold text-xs">Total Value</div>
                </div>
                <div className="text-center p-3 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-3xl border border-blue-400/30 hover:scale-105 transition-transform duration-300">
                  <div className="text-2xl md:text-3xl font-black text-cyan-400 mb-1">$0</div>
                  <div className="text-cyan-200 font-semibold text-xs">Your Investment</div>
                </div>
                <div className="text-center p-3 bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg rounded-3xl border border-orange-400/30 hover:scale-105 transition-transform duration-300">
                  <div className="text-2xl md:text-3xl font-black text-orange-400 mb-1">14</div>
                  <div className="text-orange-200 font-semibold text-xs">Days to Launch</div>
                </div>
              </div>

              {/* Dynamic CTA Button - Updated price */}
              <a href="#application" className="inline-flex items-center space-x-3 bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 hover:from-green-600 hover:via-emerald-600 hover:to-teal-600 text-white text-base font-black py-3 px-6 rounded-full transition-all duration-300 transform hover:scale-110 shadow-2xl hover:shadow-green-500/50 animate-pulse">
                <span>🎯 Claim My FREE $6,800 Website</span>
            ...
            <div className="relative max-w-6xl mx-auto">
              <div className="bg-gradient-to-r from-white/10 to-purple-500/10 backdrop-blur-xl p-4 shadow-2xl border border-white/20 rounded-3xl">
                <div className="relative h-60 md:h-80 overflow-hidden rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 shadow-inner">
                  ...
                  <div className="absolute bottom-3 left-3 bg-gradient-to-r from-black/90 to-purple-900/90 backdrop-blur-sm text-white px-3 py-2 rounded-xl shadow-lg">
                    <span className="font-bold text-sm">{websiteShowcase[currentSlide].name}</span>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-base text-slate-700 max-w-4xl mx-auto leading-relaxed font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <div key={index} className="group">
                  <div className="bg-white p-4 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-slate-100 hover:border-purple-200 transform hover:-translate-y-3 hover:scale-105 h-48 flex flex-col justify-between">
                    <div className={`w-10 h-10 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-base text-slate-700 max-w-5xl mx-auto leading-relaxed font-medium">
                We believe every business deserves success online. That's why we're investing in communities 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              {[{
                ...
                gradient: "from-purple-500 to-pink-500"
                  ...
                  <div className={`w-10 h-10 bg-gradient-to-br ${item.gradient} rounded-full flex items-center justify-center flex-shrink-0 shadow-lg`}>
            ...
            <div className="bg-gradient-to-r from-amber-100 via-orange-100 to-red-100 p-6 rounded-3xl border-l-8 border-orange-500 shadow-xl">
              ...
              <div className="bg-gradient-to-r from-orange-200 to-red-200 border-2 border-orange-300 rounded-2xl p-3 shadow-inner">
                <p className="text-base font-bold text-orange-900 flex items-center">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-base text-purple-200 max-w-3xl mx-auto">
                See the incredible value you're getting with our community support program
              </p>
            </div>

            {/* Modern Glass Card Design with updated categorized pricing */}
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl overflow-hidden">
              {/* Header */}
              <div className="bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 p-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-center">
                  <div>
                    <h3 className="text-base font-bold text-white mb-1">Professional Service</h3>
                    <p className="text-purple-200 text-xs">What you get</p>
                  </div>
                  <div>
                    <h3 className="text-base font-bold text-white mb-1">Market Rate</h3>
                    <p className="text-purple-200 text-xs">Industry standard</p>
                  </div>
                  <div>
                    <h3 className="text-base font-bold text-green-300 mb-1">CloudMor Price</h3>
                    <p className="text-green-200 text-xs">Your investment</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border-b border-white/10">
                <div className="p-3">
                  <h4 className="text-base font-bold text-blue-300 mb-1 flex items-center">
              ...
              <div className="divide-y divide-white/10">
                {[
                  ...
                  <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-3 p-3 hover:bg-white/5 transition-all duration-300 group">
                    ...
                    <div className="text-center">
                      <span className="text-red-400 font-bold text-sm bg-red-400/10 px-2 py-1 rounded-full">{price}</span>
                    </div>
                    <div className="text-center">
                      <span className="text-green-400 font-bold text-sm bg-green-400/10 px-3 py-1 rounded-full shadow-lg">FREE</span>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="bg-gradient-to-r from-pink-500/10 to-red-500/10 border-b border-white/10">
                <div className="p-3">
                  <h4 className="text-base font-bold text-pink-300 mb-1 flex items-center">
              ...
              <div className="divide-y divide-white/10">
                {[
                  ...
                  <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-3 p-3 hover:bg-white/5 transition-all duration-300 group">
                    <div className="text-white font-medium flex items-center text-sm">
                      <div className="w-1.5 h-1.5 bg-gradient-to-r from-pink-400 to-red-400 rounded-full mr-2 group-hover:scale-125 transition-transform duration-300"></div>
                      {service}
                    </div>
                    <div className="text-center">
                      <span className="text-red-400 font-bold text-sm bg-red-400/10 px-2 py-1 rounded-full">{price}</span>
              ...
              <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 border-b border-white/10">
                <div className="p-3">
                  <h4 className="text-base font-bold text-green-300 mb-1 flex items-center">
              ...
              <div className="divide-y divide-white/10">
                {[
                  ...
                  <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-3 p-3 hover:bg-white/5 transition-all duration-300 group">
                    <div className="text-white font-medium flex items-center text-sm">
                      <div className="w-1.5 h-1.5 bg-gradient-to-r from-green-400 to-emerald-400 rounded-full mr-2 group-hover:scale-125 transition-transform duration-300"></div>
                      {service}
                    </div>
                    <div className="text-center">
                      <span className="text-red-400 font-bold text-sm bg-red-400/10 px-2 py-1 rounded-full">{price}</span>
              ...
              <div className="bg-gradient-to-r from-orange-500/10 to-yellow-500/10 border-b border-white/10">
                <div className="p-3">
                  <h4 className="text-base font-bold text-orange-300 mb-1 flex items-center">
                    🔒 Security & Legal
                  </h4>
                </div>
              </div>
              ...
              <div className="divide-y divide-white/10">
                {[
                  ["Advanced Security & Threat Protection", "$200"],
                  ["Privacy Policy & Cookie Consent", "$100"],
                  ["Backup & Restore Setup", "$50"]
                ].map(([service, price], index) => (
                  <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-3 p-3 hover:bg-white/5 transition-all duration-300 group">
                    <div className="text-white font-medium flex items-center text-sm">
                      <div className="w-1.5 h-1.5 bg-gradient-to-r from-orange-400 to-yellow-400 rounded-full mr-2 group-hover:scale-125 transition-transform duration-300"></div>
                      {service}
                    </div>
                    <div className="text-center">
                      <span className="text-red-400 font-bold text-sm bg-red-400/10 px-2 py-1 rounded-full">{price}</span>
              ...
              {/* Total Row */}
              <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 border-t-4 border-green-400 grid grid-cols-1 md:grid-cols-3 gap-3 p-4">
                <div className="text-lg font-black text-white flex items-center">
                  <div className="w-2 h-2 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full mr-2"></div>
                  💰 TOTAL VALUE
                </div>
                <div className="text-center">
                  <span className="text-2xl font-black text-red-400 bg-red-400/10 px-3 py-2 rounded-full">$6,800</span>
                </div>
                <div className="text-center">
                  <span className="text-3xl font-black text-green-400 bg-green-400/10 px-4 py-2 rounded-full shadow-2xl animate-pulse">$0</span>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="hidden lg:block absolute top-16 left-0 right-0 h-0.5 border-t-2 border-dotted border-cyan-400/50"></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                {[
                  ...
                  <div key={index} className="relative text-center">
                    {/* Step Circle - Larger */}
                    <div className={`w-12 h-12 bg-gradient-to-br ${item.color} rounded-full flex items-center justify-center mx-auto mb-4 shadow-2xl relative z-10 border-4 border-white`}>
                      <span className="text-white font-bold text-sm">{item.step}</span>
                    </div>
                    
                    {/* Content Card - Fixed height and larger with smaller font */}
                    <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-3 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 h-40 flex flex-col justify-between">
                      <div>
                        <div className="text-xs font-semibold text-cyan-300 mb-1 bg-cyan-400/10 px-2 py-1 rounded-full">{item.days}</div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-3">
                Apply for Your <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">FREE $6,800 Website</span>
              </h2>
            ...
            <div className="text-center mt-4">
              <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-orange-200 rounded-2xl p-3">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              {testimonials.slice(currentTestimonial, currentTestimonial + 3).map((testimonial, index) => (
                <div key={index} className="bg-white p-4 rounded-2xl shadow-lg border border-slate-100 hover:shadow-xl transition-shadow duration-300">
                  ...
                  <footer className="border-t border-slate-100 pt-2">
                    <div className="font-semibold text-slate-900 text-xs">{testimonial.author}</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              {testimonials.slice(currentTestimonial + 3, currentTestimonial + 6).map((testimonial, index) => (
                <div key={index + 3} className="bg-white p-4 rounded-2xl shadow-lg border border-slate-100 hover:shadow-xl transition-shadow duration-300">
                  <div className="flex mb-2">
                    {[...Array(5)].map((_, i) => <Star key={i} className="h-3 w-3 text-yellow-400 fill-current" />)}
                  </div>
                  <blockquote className="text-slate-700 mb-3 text-sm leading-relaxed">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-base text-purple-200">Real businesses achieving real results</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg border border-green-400/30 rounded-3xl p-4 text-center hover:scale-105 transition-transform duration-300">
                <div className="text-3xl font-black text-green-400 mb-1">$6,800</div>
                <div className="text-green-200 font-semibold text-sm">Total Value</div>
              </div>
              
              <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg border border-blue-400/30 rounded-3xl p-4 text-center hover:scale-105 transition-transform duration-300">
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg border border-purple-400/30 rounded-3xl p-4 text-center hover:scale-105 transition-transform duration-300">
                <div className="text-3xl font-black text-purple-400 mb-1">14</div>
                <div className="text-purple-200 font-semibold text-sm">Days to Launch</div>
              </div>
              
              {/* New 23,435 tile */}
              <div className="bg-gradient-to-br from-yellow-500/20 to-orange-500/20 backdrop-blur-lg border border-yellow-400/30 rounded-3xl p-4 text-center hover:scale-105 transition-transform duration-300">
                <div className="text-3xl font-black text-yellow-400 mb-1">23,435</div>
                <div className="text-yellow-200 font-semibold text-sm">Success Stories</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              ...
              <div>
                <div className="mb-3">
                  <img src="/lovable-uploads/691e7939-254c-4028-91c9-7c00fd9a8db8.png" alt="CloudMor Logo" className="h-24 mb-3" />
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-start space-x-2 group hover:bg-slate-800 p-2 rounded-lg transition-colors">
                    ...
                    <div>
                      <p className="text-white font-semibold text-xs">Address</p>
                      <p className="text-slate-300 text-xs">1390 Market Street</p>
                      <p className="text-slate-300 text-xs">San Francisco, Suite 200</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2 group hover:bg-slate-800 p-2 rounded-lg transition-colors">
                    ...
                    <div>
                      ...
                      <a href="tel:8885546597" className="text-slate-300 hover:text-white transition-colors text-xs">
                        (888) 554-6597
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2 group hover:bg-slate-800 p-2 rounded-lg transition-colors">
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@cloudmor.com" className="text-slate-300 hover:text-white transition-colors text-xs">
                        hello@cloudmor.com
                      </a>
                    </div>
                  </div>
              ...
              <div>
                <h3 className="text-base font-bold text-white mb-3 flex items-center">
                  <div className="w-5 h-5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mr-2 flex items-center justify-center">
                    🗺️
                  </div>
                  Our Location
                </h3>
                <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-xl p-3 backdrop-blur-sm">
                  {/* Google Map Embed */}
                  ...
                  <div className="text-center">
                    <p className="text-sm font-semibold text-blue-300 mb-1">Proudly Serving</p>
                    <p className="text-white font-bold text-xs">San Francisco</p>
            ...
            <div className="border-t border-slate-700 pt-4">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <p className="text-slate-400 text-xs mb-2 md:mb-0">

...
import { CheckCircle, Star, Users, Clock, Shield, Smartphone, TrendingUp, Zap, ArrowRight, Play, MapPin, Phone, Mail, Award, Target, Rocket, Eye, Heart, DollarSign, Menu, X } from 'lucide-react';
...
const WebDesignLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-gowith-dark-blue via-gowith-medium-blue to-gowith-light-blue pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-72 h-72 bg-white/10 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-gowith-orange/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center py-20">
            ...
            <h1 className="text-5xl font-black text-white mb-6 leading-tight animate-fade-in md:text-6xl">
              PROFESSIONAL
              <span className="block bg-gradient-to-r from-gowith-orange via-yellow-400 to-gowith-orange bg-clip-text text-transparent animate-pulse">
                WEB DESIGN
              </span>
              <span className="block text-green-400">SERVICES</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in delay-300">
              🎯 Custom websites that drive results. From concept to launch, we create digital experiences that <span className="font-bold text-yellow-300">convert visitors into customers</span>.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12 max-w-4xl mx-auto">
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/30 hover:scale-105 transition-transform duration-300">
                ...
                <Shield className="w-6 h-6 text-yellow-400 mx-auto mt-2" />
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/30 hover:scale-105 transition-transform duration-300">
                <div className="text-3xl font-black text-orange-400 mb-2">SEO</div>
                <div className="text-white text-sm font-medium">Optimized</div>
                <TrendingUp className="w-6 h-6 text-orange-400 mx-auto mt-2" />
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/30 hover:scale-105 transition-transform duration-300">
                <div className="text-3xl font-black text-purple-400 mb-2">Mobile</div>
                <div className="text-white text-sm font-medium">Responsive</div>
                <Smartphone className="w-6 h-6 text-purple-400 mx-auto mt-2" />
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <button onClick={scrollToForm} className="group relative inline-flex items-center bg-gradient-to-r from-gowith-orange to-gowith-orange-hover hover:from-gowith-orange-hover hover:to-gowith-orange text-white text-xl font-black px-10 py-5 rounded-xl transition-all duration-300 transform hover:scale-110 shadow-2xl">
              ...
              <div className="relative overflow-hidden rounded-3xl shadow-2xl bg-gray-100 border-4 border-white/50">
                <div className="relative h-80 md:h-[500px] overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 bg-black/90 backdrop-blur-sm text-white px-6 py-3 rounded-xl shadow-lg">
                    ...
                    <div className="text-green-400 text-sm font-medium">✓ Professional Design</div>
                  </div>
                </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[{
                ...
                days: "Day 2-5",
                color: "from-gowith-orange to-yellow-500"
              }, {
                step: 3,
                title: "Development",
      ...
      <section id="web-design-form" className="py-20 bg-gradient-to-br from-gowith-dark-blue via-gowith-medium-blue to-gowith-light-blue text-white relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-10 left-10 w-64 h-64 bg-white/10 rounded-full blur-2xl animate-pulse"></div>
          <div className="absolute bottom-10 right-10 w-80 h-80 bg-gowith-orange/20 rounded-full blur-2xl animate-pulse delay-1000"></div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-6xl font-black mb-6">
                🚀 START YOUR <span className="text-gowith-orange animate-pulse">WEB DESIGN PROJECT</span>
              </h2>
            ...
            <div className="text-center mt-8">
              <div className="bg-gradient-to-r from-gowith-orange to-gowith-orange-hover rounded-2xl p-6 shadow-lg">

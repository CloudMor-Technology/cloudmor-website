        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="text-white">
              <p className="mb-1"><strong>Phone:</strong> <a href="tel:8885546597" className="hover:text-gray-300">(888) 554-6597</a></p>
              <p><strong>Email:</strong> <a href="mailto:sales@cloudmor.com" className="hover:text-gray-300">sales@cloudmor.com</a></p>
            </div>

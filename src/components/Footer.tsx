...
const Footer = () => {
  return (
    <footer className="bg-blue-100 text-gowith-dark-blue pt-16 pb-8">
            ...
            <form className="mt-4">
              <div className="flex flex-col sm:flex-row gap-2">
                <input 
                  ...
                  className="px-4 py-2 rounded bg-white border-2 border-gowith-light-blue text-gowith-dark-blue focus:outline-none focus:ring-2 focus:ring-gowith-medium-blue"
                  required
                />
                <button 
                  type="submit" 
        ...
        <div className="border-t border-gowith-medium-blue pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <Link to="/terms-of-service" className="text-gowith-medium-blue hover:text-gowith-dark-blue text-sm transition-colors">
                Terms of Service
              </Link>

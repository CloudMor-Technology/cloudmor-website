    ...
    backgroundImage: 'url(/lovable-uploads/20cd0b55-8167-4f6a-acfc-85fe6cab38a2.png)'
      ...
      <div className="flex flex-col items-center relative z-10 max-w-2xl mx-auto px-8 space-y-8">
        ...
        <div className="text-center">
          <h1 className="text-5xl mb-8 leading-tight text-[#183a85] font-bold lg:text-6xl"> Welcome to CloudMor Client Portal</h1>
        </div>
        ...
        <div className="text-center">
          <p className="text-2xl leading-relaxed text-orange-500 font-semibold lg:text-3xl">Manage your account, billing, and services securely in one place</p>
        </div>
      </div>
    </div>;
};